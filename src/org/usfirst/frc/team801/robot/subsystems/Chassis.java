...
public class Chassis extends Subsystem
{
	...
	public void motorDrive(double angleCmd_Deg)
	{
		...
		// x = Utils.limitMagnitude(Utils.joyExpo(Robot.oi.driver.getX(), 1.5), 0.01,
		// 1.0);
		// y = Utils.limitMagnitude(Utils.joyExpo(Robot.oi.driver.getY(), 1.5), 0.01,
		// 1.0);
		// // average x and y
		...
		// y = Utils.limitMagnitude(Utils.joyExpo(Robot.oi.driver.getY(), 1.5), 0.01,
		// 1.0);
		// z = Utils.limitMagnitude(Utils.joyExpo(Robot.oi.driver.getRawAxis(4), 1.5),
		// 0, 1.0);
	...
	// public void turnToHeading(double x, double y, double gyroCMD, double
	// angleCmd) {
	//
	// headingCMD = gyroCMD;
	// headingError = Robot.chassis.getGyroAngle() - headingCMD;
...
// (Math.sqrt(y_g.getAverage() * y_g.getAverage() + x_g.getAverage() *
// x_g.getAverage()))) * 180
// / Math.PI);
...
// }
//
// public void motorCMDDriveAngle(double x, double y, double z, double
// headingCmd) {
