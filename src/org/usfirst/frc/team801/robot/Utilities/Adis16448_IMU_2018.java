...
public class Adis16448_IMU_2018 extends GyroBase implements Gyro, PIDSource, Sendable {
  ...
  private static class AcquireTask implements Runnable {
    private Adis16448_IMU_2018 imu;
    public AcquireTask(Adis16448_IMU_2018 imu) {
      this.imu = imu;
    }
  ...
  private static class CalculateTask implements Runnable {
    private Adis16448_IMU_2018 imu;
    public CalculateTask(Adis16448_IMU_2018 imu) {
      this.imu = imu;
    }
   ...
   */
  public Adis16448_IMU_2018(Axis yaw_axis, AHRSAlgorithm algorithm) {
    m_yaw_axis = yaw_axis;
   ...
   */
  public Adis16448_IMU_2018(Axis yaw_axis) {
